//section 26 : Operator Overloading
...
class V3 {
    public:
        ...
        /**operator plus  *
        * this operator will be used to add two object of same type using symbol '+'  **/
        V3 operator+ (const V3 &b) const{
            return V3(x + b.x, y + b.y, z + b.z);
        }
        /**operator multiply  *
        * this operator will be used to multiply a object with a factor using symbol '*'  **/
